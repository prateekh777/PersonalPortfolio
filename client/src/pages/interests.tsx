    ...
    <div className="space-y-8 pt-16 px-4 sm:px-6 mx-auto max-w-screen-xl" 
      ...
      <div className="text-base max-w-2xl mx-auto">
        <div>
          ...
          <h2 className="text-lg sm:text-xl font-bold mt-5 mb-2 text-[#222222]">Spirituality: The Depth Within</h2>
          ...
          <h2 className="text-lg sm:text-xl font-bold mt-5 mb-2 text-[#222222]">Science: The Curiosity That Never Ends</h2>
          ...
          <h2 className="text-lg sm:text-xl font-bold mt-5 mb-2 text-[#222222]">Startups: The Art of Building</h2>
