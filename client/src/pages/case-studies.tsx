...
const caseStudiesData: CaseStudyData[] = [
  {
    ...
    result: "We improved the conversion rate from demo sessions to paid customers by 30% within three months and maintained the uplift over time by establishing a structured, insight-driven approach to trial sessions.",
    actions: [
      {
  ...
  {
    id: 2,
    title: "Hiring 500+ Remote Teachers in Indonesia with Language & Cultural Barriers",
    result: "Built a scalable hiring model that enabled us to recruit and retain 500+ quality teachers within a year, overcoming remote work challenges, foreign language barriers, and cultural differences.",
    actions: [
      {
  ...
  },
  {
    ...
    result: "Successfully expanded RoboChamp kit shipments to three key international markets while reducing logistical costs by 25% through optimized vendor partnerships and localized distribution.",
    actions: [
      {
  ...
  return (
    <Card className="mb-16 overflow-hidden border-0 shadow-lg">
      <div className="bg-primary p-6 text-primary-foreground">
        <h2 className="mb-3 text-2xl font-bold lg:text-3xl">{data.title}</h2>
      </div>
      ...
      <CardContent className="p-6 lg:p-8">
        ...
        {/* Context section */}
        <div>
          <h3 className="mb-4 text-xl font-semibold text-primary">Context ({data.context.heading})</h3>
    ...
    <div className="container mx-auto max-w-4xl space-y-8 py-12 lg:py-16">
      <div className="mb-12 text-center">
        ...
        <p className="mx-auto max-w-2xl text-lg text-muted-foreground">
          In-depth looks at complex problems I've solved and the approaches I took to deliver meaningful results.
        </p>
      </div>
