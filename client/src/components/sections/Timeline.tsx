  ...
  "tech-leader": [
    {
      ...
      description: "<i>Scaling isn't just about growth—it's about stability.</i> At Complori, I led key initiatives that ensured conversion rates stayed strong despite scaling challenges. <i>By refining engagement models and optimizing operational processes, we built a resilient system that supported long-term retention and sustained learner success.</i>",
